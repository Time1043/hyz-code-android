...
import com.example.aidltest.IPersonInterface;
import com.example.aidltest.Person;

import java.util.List;

/**
 * 测试Service跨进程Aidl通信Activity
 */
public class ServiceAidlIpcActivity extends AppCompatActivity implements View.OnClickListener {

    private final String TAG = "ServiceIpcActivity";
