...
public class LifeCycleDialogActivity extends AppCompatActivity {
    ...
    private final String TAG = "LifeCycleDialogActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lifecycledialog);
        Button finish = findViewById(R.id.ac_lifecycledialog_finish);
        finish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LifeCycleDialogActivity.this.finish();
            }
        });
    }
